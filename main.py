...
class GaleriaMonitorApp:
    def __init__(self):
        ...
        self.overlay_var = tk.StringVar(value=self._arte_padrao("overlay.png"))
    ...
    def _build_ui(self):
        ...
        ttk.Entry(overlay_row, textvariable=self.overlay_var, style="App.TEntry").grid(row=0, column=1, sticky="ew", padx=(8, 8))
